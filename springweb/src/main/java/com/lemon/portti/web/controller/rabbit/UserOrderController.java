...
import com.lemon.portti.dto.LogDto;
import com.lemon.portti.dto.UserOrderDto;
import com.lemon.portti.persistence.entity.UserOrder;
import com.lemon.portti.persistence.mapper.UserOrderMapper;
import com.lemon.portti.rabbitmq.service.CommonLogService;
...
public class UserOrderController {
    ...
    public BaseResponse pushUserOrder(@RequestBody UserOrderDto dto){
        ...
        try {
            ...
            Message msg=
                    MessageBuilder.withBody(objectMapper.writeValueAsBytes(dto)).setDeliveryMode(
